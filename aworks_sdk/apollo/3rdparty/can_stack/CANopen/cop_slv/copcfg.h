...
#define CCM_MODULE_INTEGRATION          (0x00000935L) /* slv */
...
// =========================================================================
// CNA driver specific configurations
// =========================================================================
...
// if more then one instance is used, the used CAN-controllers are
// set here bit-oriented: CAN1 - 1; CAN2 - 2; CAN3 - 4; CAN4 - 8
#define CDRV_2294_USED_CAN_CONTROLLER        (1)
//#define CDRV_2294_USED_CAN_CONTROLLER        (1 + 2)
//#define CDRV_2294_USED_CAN_CONTROLLER        (1 + 2 + 4)          // LPC2294 only!!!
//#define CDRV_2294_USED_CAN_CONTROLLER        (1 + 2 + 4 + 8)      // LPC2294 only!!!
...
#define OBD_USE_VARIABLE_SUBINDEX_TAB   TRUE

// if OBD_USER_OD is set to TRUE then code will be generated for user OD
//#define OBD_USER_OD                     FALSE
#define OBD_USER_OD                     TRUE

// if OBD_USE_DYNAMIC_OD is TRUE code will be generated for dynamic OD
// In this case OBD_USER_OD and OBD_USE_VARIABLE_SUBINDEX_TAB also have to be set to TRUE!
//#define OBD_USE_DYNAMIC_OD              FALSE
#define OBD_USE_DYNAMIC_OD              TRUE
...
#define PDO_USE_BIT_MAPPING             TRUE
