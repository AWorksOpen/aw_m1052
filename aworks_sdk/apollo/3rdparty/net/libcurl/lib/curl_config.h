...
#undef  fseek
#define fseek(f,b,c)     (curl_io_lseek(f, b, c))
#undef  ferror
#define ferror( f )      (0)

#define fputc            curl_io_fputc
#define fputs            curl_io_fputs
#define fgetc            curl_io_fgetc
#define fgets            curl_io_fgets

#define fflush           curl_io_fflush

#define setvbuf          curl_io_setvbuf

#endif


#define struct_stat struct aw_stat
