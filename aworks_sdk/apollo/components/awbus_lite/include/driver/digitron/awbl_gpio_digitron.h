...
aw_local aw_inline void awbl_gpio_digitron_com_data_send(
    struct awbl_gpio_digitron_dev *p_this, uint8_t idx)
{
    p_this->pfn_com_data_send(p_this, idx);
}

aw_local aw_inline void awbl_gpio_digitron_seg_data_send(
    struct awbl_gpio_digitron_dev *p_this, uint8_t idx)
{
    p_this->pfn_seg_data_send(p_this, idx);
}

aw_local aw_inline void awbl_gpio_digitron_black_cb(
    struct awbl_gpio_digitron_dev *p_this, uint8_t idx)
{
