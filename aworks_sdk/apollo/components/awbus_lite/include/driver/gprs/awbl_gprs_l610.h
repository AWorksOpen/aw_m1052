...
#ifndef __AWBL_GPRS_L610_H__
#define __AWBL_GPRS_L610_H__
...
#define AWBL_GPRS_L610_NAME   "l610"

/** \brief N58设备状态 */
typedef enum l610_status {
    /** \brief 模块启动复位 */
    AWBL_GPRS_L610_RST_ON             = 0x00000001,
    /** \brief 内部协议栈的ppp开启  */
    AWBL_GPRS_L610_GPRS_PPP_OK        = 0x00000001<<3,
    /** \brief gprs的PDP设置完成  */
    AWBL_GPRS_L610_GPRS_PDP_OK        = 0x00000001<<5,
    /** \brief SIM卡正常 （如果sim卡正常，信号正常，却发不出短信，则欠费） */
    AWBL_GPRS_L610_SIM_OK             = 0x00000001<<6,
} awbl_gprs_l610_status_e;

/** \brief L610设备信息*/
struct awbl_gprs_l610_devinfo {
...
struct awbl_gprs_l610_dev {
    ...
    const struct awbl_gprs_l610_devinfo  *p_devinfo;        /**< \brief L610设备信息*/
    int                                   status;           /**< \brief 设备的状态 */
    void                                 *p_pipe;           /**< \brief L610 AT管道句柄*/
