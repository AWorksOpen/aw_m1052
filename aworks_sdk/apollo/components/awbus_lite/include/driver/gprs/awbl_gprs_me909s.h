...
#define AWBL_GPRS_ME909S_NAME   "me909s"

/** \brief ME909s设备状态 */
typedef enum me909s_status {
    /** \brief 模块启动复位 */
    AWBL_GPRS_ME909S_RST_ON             = 0x00000001,
    /** \brief 内部协议栈的ppp开启  */
    AWBL_GPRS_ME909S_GPRS_PPP_OK        = 0x00000001<<3,
    /** \brief gprs的PDP设置完成  */
    AWBL_GPRS_ME909S_GPRS_PDP_OK        = 0x00000001<<5,
    /** \brief SIM卡正常 （如果sim卡正常，信号正常，却发不出短信，则欠费） */
    AWBL_GPRS_ME909S_SIM_OK             = 0x00000001<<6,
...
struct awbl_gprs_me909s_dev {
    ...
    const struct awbl_gprs_me909s_devinfo *p_devinfo;        /**< \brief ME909s设备信息*/
    int                                    status;           /**< \brief 设备的状态 */
    void                                  *p_pipe;           /**< \brief ME909s AT管道句柄*/
