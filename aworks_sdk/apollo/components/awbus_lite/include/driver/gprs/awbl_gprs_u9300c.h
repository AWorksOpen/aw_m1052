...
#define AWBL_GPRS_U9300C_NAME   "u9300c"
...
struct awbl_gprs_u9300c_dev {
    ...
    const struct awbl_gprs_u9300c_devinfo *p_devinfo;        /**< \brief U9300C设备信息*/
    int                                    status;           /**< \brief 设备的状态 */
    void                                  *p_pipe;           /**< \brief U9300C AT管道句柄*/
