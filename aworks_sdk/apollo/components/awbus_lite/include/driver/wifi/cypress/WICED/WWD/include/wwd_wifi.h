 ...
 *            Error code   : if an error occurred
 */
extern wwd_result_t wwd_wifi_start_ap( wiced_ssid_t* ssid, wiced_security_t auth_type, /*@unique@*/ const uint8_t* security_key, uint8_t key_length, uint8_t channel, int hide_ssid );
 ...
 * @param[in] key_length   : The length of the security_key in bytes.
 * @param[in] channel      : 802.11 channel number
 * @param[in] hide_ssid    : Hide Network Name (SSID)
 * @return     @ref wwd_result_t
 */
extern wwd_result_t wwd_wifi_ap_init( wiced_ssid_t* ssid, wiced_security_t auth_type, const uint8_t* security_key, uint8_t key_length, uint8_t channel, int hide_ssid );
...
/** Turn off roaming
 *
 * @param disable         : Boolean value which if AW_TRUE will turn roaming off and if AW_FALSE will turn roaming on
 *
 ...
 *        disable         : Boolean value which if AW_TRUE will turn 11n off and if AW_FALSE will turn 11n on
 *
