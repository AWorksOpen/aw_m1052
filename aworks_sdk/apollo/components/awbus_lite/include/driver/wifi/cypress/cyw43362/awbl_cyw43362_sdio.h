...
#ifdef CONFIG_DRV_CYW43362_SDIO
...
#define __DEV_CONVERT(p_this, p_arg) \
        awbl_sdio_cyw43362_wlan_dev_t *p_this = \
            (awbl_sdio_cyw43362_wlan_dev_t*) p_arg

#define __DEV_DECL(p_this, p_dev) \
    awbl_sdio_cyw43362_wlan_dev_info_t *__info = \
                     (awbl_sdio_cyw43362_wlan_dev_info_t *) \
                          ((struct awbl_dev *) p_dev)->p_devhcf->p_devinfo; \
    awbl_sdio_cyw43362_wlan_dev_t *p_this = \
        (awbl_sdio_cyw43362_wlan_dev_t *) __info->super.p_drv;
...
#define __INF_DECL(p_info, p_dev) \
    ...
    if (__gp_cyw43362_sdio_info != NULL) \
        p_info = \
            (awbl_sdio_cyw43362_wlan_dev_info_t *) __gp_cyw43362_sdio_info; \
    else \
