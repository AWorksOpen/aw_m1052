...
extern int                umAddUser(char_t *user, char_t *password,
                          char_t *group, aw_bool_t protect, aw_bool_t disabled);
...
extern aw_bool_t          umUserExists(char_t *user);
...
extern aw_bool_t          umGetUserEnabled(char_t *user);
extern int                umSetUserEnabled(char_t *user, aw_bool_t enabled);

extern aw_bool_t          umGetUserProtected(char_t *user);
extern int                umSetUserProtected(char_t *user, aw_bool_t protect);

/*
 *    umGroup functions use a group name for a key
 */
extern int              umAddGroup(char_t *group, short privilege,
                        accessMeth_t am, aw_bool_t protect, aw_bool_t disabled);
...
extern aw_bool_t        umGroupExists(char_t *group);
extern aw_bool_t        umGetGroupInUse(char_t *group);

extern accessMeth_t     umGetGroupAccessMethod(char_t *group);
extern int              umSetGroupAccessMethod(char_t *group, accessMeth_t am);

extern aw_bool_t        umGetGroupEnabled(char_t *group);
extern int              umSetGroupEnabled(char_t *group, aw_bool_t enabled);

extern short            umGetGroupPrivilege(char_t *group);
extern int              umSetGroupPrivilege(char_t *group, short privileges);

extern aw_bool_t        umGetGroupProtected(char_t *group);
extern int              umSetGroupProtected(char_t *group, aw_bool_t protect);

/*
 *    umAccessLimit functions use a URL as a key
 */
extern int            umAddAccessLimit(char_t      *url,
                                       accessMeth_t am,
                                       short        secure, 
                                       char_t      *group);
...
extern aw_bool_t      umAccessLimitExists(char_t *url);
...
extern aw_bool_t       umUserCanAccessURL(char_t *user, char_t *url);
