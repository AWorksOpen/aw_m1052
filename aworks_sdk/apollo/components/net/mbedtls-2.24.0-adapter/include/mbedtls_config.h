...
#ifndef fileno
#define fileno               mbedtls_io_flieno
...
//typedef __FILE_t FILE;
#define FILE    __FILE_t
#define __FILE  FILE
...
#undef  stdin    
#define stdin            stdin_fd
#undef  stdout
#define stdout           stdout_fd
#undef  stderr  
...
#define time(a)          (aw_time(a))

#undef  ferror
#define ferror( f )      (0)

#define fputc            mbedtls_io_fputc
#define fputs            mbedtls_io_fputs
#define fgetc            mbedtls_io_fgetc
#define fgets            mbedtls_io_fgets

#define fflush           mbedtls_io_fflush

#define setvbuf          mbedtls_io_setvbuf
