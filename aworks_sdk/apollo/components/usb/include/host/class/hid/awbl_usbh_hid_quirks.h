/************************************************
 * create by CYX at 3/16-2020
 * USB Human Interface Device Driver Quirks
 ************************************************/
#ifndef __AWBL_USBH_HID_QUIRKS_H
#define __AWBL_USBH_HID_QUIRKS_H
...
uint32_t awbl_usbh_usbhid_lookup_quirk(const uint16_t idVendor, const uint16_t idProduct);
