...
#ifndef __ARMV8M_EXC_H
#define __ARMV8M_EXC_H
 ...
 */
void armv8m_exc_hardfault_handler(void);

/**
 * \brief MemManage 异常处理函数
 */
void armv8m_exc_memmanage_handler(void);

/**
 * \brief BusFault 异常处理函数
 */
void armv8m_exc_busfault_handler(void);

/**
 * \brief UsageFault 异常处理函数
 */
void armv8m_exc_usagefault_handler(void);
 ...
 * \brief pendSV 异常处理函数
 */
void armv8m_exc_pendsv_handler(void);
...
/** @} grp_armv8m_exc_usrcfg */

#ifdef __cplusplus
}
#endif /* __cplusplus     */

#endif /* __ARMV8M_EXC_H */
