...
/* cpu spec barrier */
#define rtk_arm_barrier_dmb()   asm volatile("dmb" : : : "memory")
#define rtk_arm_barrier_dsb()   asm volatile("dsb" : : : "memory")
#define rtk_arm_barrier_isb()   asm volatile("isb" : : : "memory")
