...
/**
 * \file
 * \brief imx1010 eDMA driver header file
 *
...
#ifndef __AWBL_IMX1010_EDMA_H
#define __AWBL_IMX1010_EDMA_H
...
typedef struct edma_engine {
    ...
    struct awbl_imx1010_edma_service edma_serv;

} awbl_imx1010_edma_dev_t;

/**
 * \brief imx1010 eDMA  设备信息
 */
typedef struct awbl_imx1010_edma_devinfo {
