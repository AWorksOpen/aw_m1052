...
/**
 * \file
 * \brief AWBus-lite iMX RT1010 GPIO 驱动
 *
 ...
 *  - 驱动名:   "imx1010_gpio"
 *  - 总线类型: AWBL_BUSID_PLB
 *  - 设备信息: struct awbl_imx1010_gpio_devinfo
 *
 * \internal
...
#ifndef __AWBL_IMX1010_GPIO_H
#define __AWBL_IMX1010_GPIO_H
...
/** \brief IMX1010 GPIO 驱动名 */
#define AWBL_IMX1010_GPIO_NAME   "imx1010_gpio"

/** \brief IMX1010 GPIO 的端口(bank)数 */
#define  IMX1010_GPIO_PORTS   4

/** \brief IMX1010 GPIO 每端口含的GPIO个数 */
#define  IMX1010_PORT_PINS    32


/** \brief IMX1010 GPIO平台初始化函数指针 */
typedef void (*pfn_gpio_plat_init_t)(void);


/**
 * \brief IMX1010 GPIO 设备信息
 */
struct awbl_imx1010_gpio_devinfo{
 ...
 */
struct awbl_imx1010_gpio_trigger_info {
...
/**
 * \brief IMX1010 GPIO 设备实例
 */
struct awbl_imx1010_gpio_dev {
    ...
    /** \brief GPIO 引脚ISR信息 */
    struct awbl_imx1010_gpio_trigger_info trig_info[IMX1010_GPIO_PINS];
