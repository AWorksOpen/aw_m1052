...
#ifndef __IMX1010_CCM_REGS_H
#define __IMX1010_CCM_REGS_H
...
/**
 * \addtogroup grp_imx1010_ccm_regs 时钟控制模块寄存器描述
 * @{
 */
...
} imx1010_ccm_analog_regs_t;

/** @} end of grp_imx1010_ccm_regs */
