...
static aw_clk_rate_t pll_usb1_recalc_rate(
        ...
        aw_clk_rate_t parent_rate)
{
    imx1010_ccm_analog_regs_t   *p_ccm_analog;
    p_ccm_analog = (imx1010_ccm_analog_regs_t *)IMX1010_CCM_ANALOG_BASE;
...
{
    imx1010_ccm_regs_t         *p_ccm;
    p_ccm = (imx1010_ccm_regs_t *)IMX1010_CCM_BASE;
...
struct clk * imx1010_clk_register_pll_usb1(
