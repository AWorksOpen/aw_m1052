...
aw_local awbl_imx1010_flexspi_service_t __gp_flexspi_serv ;

AWBL_METHOD_DEF(awbl_imx1010_flexspi_serv_func_get,
                "awbl_imx1010_flexspi_serv_func_get");

/**
 * \brief allocate imx1010 flexspi service from instance (helper)
 *
 ...
 */
aw_local aw_err_t __imx1010_flexspi_serv_helper (struct awbl_dev *p_dev,
                                                 void            *p_arg)
{
    ...
    awbl_method_handler_t   pfn_imx1010_flexspi_get_serv = NULL;
    pfn_imx1010_flexspi_get_serv = awbl_dev_method_get(p_dev,
            AWBL_METHOD_CALL(awbl_imx1010_flexspi_serv_func_get));

    __gp_flexspi_serv.p_dev = (void *)p_dev;

    if(NULL != pfn_imx1010_flexspi_get_serv) {
        pfn_imx1010_flexspi_get_serv(p_dev, &(__gp_flexspi_serv.p_func));
    }
    return AW_OK;
}
 ...
 */
void awbl_imx1010_flexspi_init (void)
{

    awbl_dev_iterate(__imx1010_flexspi_serv_helper,
                     NULL,
