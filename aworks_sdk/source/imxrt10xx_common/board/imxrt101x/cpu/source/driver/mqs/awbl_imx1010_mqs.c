...
/**
 * \file
 * \brief The IMX1010 Medium Quality Sound driver
 *
 * \internal
...
#include "driver/mqs/awbl_imx1010_mqs.h"
...
/*******************************************************************************
  Global defines
*******************************************************************************/
struct awbl_imx1010_mqs_dev *__gp_mqs_dev = NULL;
...
#define __MQS_DEV_DECL(p_this, p_dev) \
    struct awbl_imx1010_mqs_dev *p_this = \
        (struct awbl_imx1010_mqs_dev *)(p_dev)

#define __MQS_DEVINFO_DECL(p_devinfo, p_dev) \
    struct awbl_imx1010_mqs_devinfo *p_devinfo = \
        (struct awbl_imx1010_mqs_devinfo *)AWBL_DEVINFO_GET(p_dev)

void awbl_imx1010_mqs_init (
    struct awbl_imx1010_mqs_dev            *p_dev,
    const struct awbl_imx1010_mqs_devinfo  *p_devinfo);
...
/* Reset The MQS */
aw_local
aw_err_t awbl_imx1010_mqs_reset (void)
{
...
/* Enable The MQS */
aw_local
aw_err_t awbl_imx1010_mqs_config (uint32_t samples_rate,
                                  uint8_t  width,
                                  uint8_t  channels)
{
    __MQS_DEVINFO_DECL(p_devinfo, __gp_mqs_dev);
...
/* Enable The MQS */
aw_err_t awbl_imx1010_mqs_enable (void)
{
    __MQS_DEVINFO_DECL(p_devinfo, __gp_mqs_dev);
...
/* Disable The MQS */
aw_err_t awbl_imx1010_mqs_disable (void)
{
    __MQS_DEVINFO_DECL(p_devinfo, __gp_mqs_dev);
...
aw_local void __sai_inst_connect(awbl_dev_t *p_dev)
{
    ...
    __gp_mqs_dev = (struct awbl_imx1010_mqs_dev *)p_dev;


    /* ³õÊ¼»¯Éù¿¨ */
    awbl_imx1010_mqs_init (__gp_mqs_dev, p_devinfo);
...
aw_local aw_const awbl_plb_drvinfo_t __g_mqs_drv_registration = {
    {
        ...
        AWBL_IMX1010_MQS_NAME,  /* p_drvname */
...
/* imx1010 mqs init */
aw_local aw_err_t __imx1010_mqs_init (struct awsa_soc_pcm *p_soc_pcm)
{

    awbl_imx1010_mqs_reset();
    awbl_imx1010_mqs_enable();
    return AW_OK;
}
...
/* imx1010 mqs startup  */
aw_local
aw_err_t __imx1010_mqs_startup (struct awsa_soc_pcm *p_soc_pcm)
{
    return AW_OK;
}
...
/* imx1010 mqs config */
aw_local
aw_err_t __imx1010_mqs_config (struct awsa_soc_pcm *p_soc_pcm,
                               ...
                               awsa_pcm_config_t   *p_config)
{
    ...
    ret = awbl_imx1010_mqs_config (p_config->rate,
                                   width,
                                   p_config->channels);
    return ret;
}

/* imx1010 mqs shutdown */
aw_local
aw_err_t __imx1010_mqs_shutdown(struct awsa_soc_pcm *p_soc_pcm,
                                awsa_pcm_stream_t    stream)
{
...
/* servopts */
aw_local const struct awsa_soc_servopts __g_imx1010_mqs_opts = {
    NULL,
    NULL,
    __imx1010_mqs_startup,
    __imx1010_mqs_shutdown,
    __imx1010_mqs_config,
    NULL,
    NULL,
    NULL,
    NULL,
...
/* connects codec <--> plfm */
aw_local const struct awsa_soc_dai_link __g_imx1010_mqs_dai_link = {
    "imx1010_mqs",           /**< \brief dai_link name */
    "mqs_duplex",            /**< \brief Stream name */
    "mqs_codec",             /**< \brief for multi-codec */
    "awbl_imx1010_sai",      /**< \brief for multi-platform */
    "imx1010",               /**< \brief platform dai name */
    "mqs_playback",          /**< \brief codec dai name */
    __imx1010_mqs_init,
    &__g_imx1010_mqs_opts,
};


/* card driver */
aw_local const
struct awsa_soc_card_driver __g_imx1010_mqs_card_driver = {
    &__g_imx1010_mqs_dai_link,
    1,
    NULL,
    NULL,
    NULL,
    ...
    const struct awbl_imx1010_mqs_devinfo  *p_devinfo)
{
    ...
    awsa_soc_card_register(&p_dev->soc_card,
                           p_devinfo->card_id,
                           "imx1010_mqs_soundcard",
                           &p_dev->soc_pcm,
                           1,
                           NULL,
                           0,
                           &__g_imx1010_mqs_card_driver,
                           (void *)p_dev);
}

/******************************************************************************/
void awbl_imx1010_mqs_drv_register (void)
{
