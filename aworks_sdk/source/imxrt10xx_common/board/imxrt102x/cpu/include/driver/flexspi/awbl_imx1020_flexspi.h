...
#ifndef __AWBL_IMX1020_FLEXSPI_H
#define __AWBL_IMX1020_FLEXSPI_H
...
#include "driver/flexspi/awbl_imx1020_flexspi_op.h"
#include "driver/flexspi/imx1020_flexspi_regs.h"
#include "driver/flexspi/awbl_imx1020_flexspi_service.h"
#include "driver/flexspi/awbl_imx1020_flexspi_nvram.h"

#define AWBL_IMX1020_FLEXSPI_NAME   "imx1020_flexspi"
...
/**
 * \brief iMX RT1020 Flexspi 设备信息
 */
typedef struct awbl_imx1020_flexspi_devinfo {
...
} awbl_imx1020_flexspi_devinfo_t;

/**
 * \brief iMX RT1020  Flexspi 设备实例
 */
typedef struct awbl_imx1020_flexspi_dev {

    struct awbl_dev super;     /**< \brief 继承自 AWBus 设备 */
    struct awbl_flexspi_servfuncs  serv_func;

} awbl_imx1020_flexspi_dev_t;


/**
 * \brief iMX RT1020 FlexSPI master driver register
 */
void awbl_imx1020_flexspi_drv_register (void);


#endif /* __AWBL_IMX1020_FLEXSPI_H */
