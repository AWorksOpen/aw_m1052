...
#ifndef __AWBL_IMX1020_FLEXSPI_OP_H
#define __AWBL_IMX1020_FLEXSPI_OP_H
...
#define AWBL_FLEXSPI_NOR_OP_IRRD          0x68    /* read  security infomation row */
#define AWBL_FLEXSPI_NOR_OP_IRP           0x62    /* write security infomation row */ 
#define AWBL_FLEXSPI_NOR_OP_IRER          0x64    /* erase security infomation row */      
...
#endif /* __AWBL_IMX1020_FLEXSPI_OP_H */
