#ifndef         __IMX1020_CLK_H__
#define         __IMX1020_CLK_H__

#define IMX_CLK_DECL_IN(name) \
    struct clk * imx1020_clk_register_##name( \
...
#define CCM_ANAOLG      ((imx1020_ccm_analog_regs_t *)IMX1020_CCM_ANALOG_BASE)
#define CCM             ((imx1020_ccm_regs_t *)IMX1020_CCM_BASE)
#endif
