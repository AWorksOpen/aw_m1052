...
/**
 * \file
 * \brief iMX RT1020 FlexSPI driver
 *
 * \internal
...
#define __FLEXSPI_DEV_DECL(p_this, p_dev) \
    struct awbl_imx1020_flexspi_dev *p_this = \
        (struct awbl_imx1020_flexspi_dev *)(p_dev)

/* declare FLEXSPI device infomation */
#define __FLEXSPI_DEVINFO_DECL(p_devinfo, p_dev) \
    struct awbl_imx1020_flexspi_devinfo *p_devinfo = \
        (struct awbl_imx1020_flexspi_devinfo *)AWBL_DEVINFO_GET(p_dev)

/* get imx1020 spi hardware infomation */
#define __FLEXSPI_HW_DECL(p_hw_flexspi, p_devinfo)      \
        imx1020_flexspi_regs_t *p_hw_flexspi =          \
        ((imx1020_flexspi_regs_t *)((p_devinfo)->regbase))
 ...
 */
aw_local void __flexspi_lut_lock (imx1020_flexspi_regs_t *p_hw_flexspi)
{
    /* Lock LUT. */
 ...
 */
aw_local void __flexspi_lut_unlock (imx1020_flexspi_regs_t *p_hw_flexspi)
{
 ...
 */
__attribute__((used, section(".ram.func")))
aw_local void __flexspi_wait_idle(struct awbl_imx1020_flexspi_devinfo *p_devinfo)
{
    uint8_t status;
 ...
 */
__attribute__((used, section(".ram.func")))
aw_local aw_err_t __flexspi_do_write(imx1020_flexspi_regs_t *p_hw_flexspi,
                                     uint8_t                *p_buf,
                                     size_t                  size)
{
    aw_err_t  ret = AW_OK;
 ...
 */
__attribute__((used, section(".ram.func")))
aw_local aw_err_t __flexspi_do_read(imx1020_flexspi_regs_t *p_hw_flexspi,
                                    uint8_t                *p_buf,
                                    size_t                  size)
{
    aw_err_t  ret = AW_OK;
 ...
 */
__attribute__((used, section(".ram.func")))
aw_err_t __flexspi_do_transfer (struct awbl_imx1020_flexspi_devinfo *p_devinfo,
                                struct flexspi_transfer              *p_trans)
{
 ...
 * \brief DLL配置
 */
aw_local uint32_t __flexspi_dll_config(struct awbl_imx1020_flexspi_dev *p_this)
{
    __FLEXSPI_DEVINFO_DECL(p_devinfo, p_this);
    __FLEXSPI_HW_DECL(p_hw_flexspi, p_devinfo);
 ...
 * \param[in] p_devinfo device information
 */
aw_local void __flexspi_lut_init(struct awbl_imx1020_flexspi_devinfo *p_devinfo)
{
    __FLEXSPI_HW_DECL(p_hw_flexspi, p_devinfo);
    uint32_t lut_base;
    int      i;
...
aw_local aw_err_t __imx1020_flexspi_serv_func_get (struct awbl_dev *p_dev,
                                                   void            *p_arg)
{
    __FLEXSPI_DEV_DECL(p_this, p_dev);
...
AWBL_METHOD_IMPORT(awbl_imx1020_flexspi_serv_func_get);

aw_local aw_const struct awbl_dev_method __g_flexspi_dev_methods[] = {
    AWBL_METHOD(awbl_imx1020_flexspi_serv_func_get,
                __imx1020_flexspi_serv_func_get),
...
aw_local aw_const awbl_plb_drvinfo_t __g_flexspi_drv_registration = {
    {
        ...
        AWBL_IMX1020_FLEXSPI_NAME,              /* p_drvname */
...
/******************************************************************************/
void awbl_imx1020_flexspi_drv_register (void)
{
