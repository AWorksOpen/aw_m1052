...
#include "imx1020_ccm.h"
#include "imx1020_xtal_osc24m.h"
#include "imx1020_xtal_osc24m_regs.h"

void ccm_clpcr_set_run_mode(void)
{
    imx1020_ccm_regs_t         *p_ccm_regs;
    uint32_t                    temp;

    p_ccm_regs = (imx1020_ccm_regs_t *)IMX1020_CCM_BASE;
...
{
    imx1020_ccm_analog_regs_t  *p_ccm_analog_regs;
    imx1020_xtal_osc24m_regs_t *p_osc24m_regs;
    uint32_t                    temp;

    p_ccm_analog_regs = (imx1020_ccm_analog_regs_t *)IMX1020_CCM_ANALOG_BASE;
