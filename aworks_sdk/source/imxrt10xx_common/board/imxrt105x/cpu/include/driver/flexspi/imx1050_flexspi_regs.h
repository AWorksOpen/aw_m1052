...
#ifndef __IMX1050_FLEXSPI_REGS_H
#define __IMX1050_FLEXSPI_REGS_H
...
{
    flexspi_command,    /** \brief 写命令操作 */
    flexspi_config,     /** \brief 配置设备操作 */
...
#define __FLEXSPI_MCR2_RESUMEWAIT(x)               (((x) & 0x1) << __FLEXSPI_MCR2_RESUMEWAIT_SHIFT)
