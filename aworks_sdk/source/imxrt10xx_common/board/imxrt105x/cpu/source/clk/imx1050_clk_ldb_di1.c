...
aw_const static struct simple_mux_desc ldb_di1_clk_sel_desc = {
        {
...
SIPMLE_MUX_CLK_DEFS(ldb_di1_clk_sel,ldb_di1_clk_sel_desc);

struct clk * imx1050_clk_register_ldb_di1_clk_sel(
        struct clk *p_ldb_di1_clk_sel,
        aw_clk_id_t clk_id,
        const char *name)
{
...
static aw_const struct simple_div_table_clk_desc ldb_di1_ipu_div_desc = {
...
SIPMLE_DIV_TABLE_CLK_DEFS(ldb_di1_ipu_div,ldb_di1_ipu_div_desc)

struct clk * imx1050_clk_register_ldb_di1_ipu_div(
        struct clk *p_ldb_di1_ipu_div,
        aw_clk_id_t clk_id,
        const char *name,
