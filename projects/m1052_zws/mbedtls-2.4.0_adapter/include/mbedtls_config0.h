...
#define MBEDTLS_PLATFORM_STD_CALLOC aw_mem_calloc
#define MBEDTLS_PLATFORM_STD_FREE aw_mem_free
...
//#define MBEDTLS_PLATFORM_CALLOC_MACRO        calloc /**< Default allocatoar macro to use, can be undefined */
//#define MBEDTLS_PLATFORM_FREE_MACRO            free /**< Default free macro to use, can be undefined */
#define MBEDTLS_PLATFORM_EXIT_MACRO            exit /**< Default exit macro to use, can be undefined */
//#define MBEDTLS_PLATFORM_TIME_MACRO            time /**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
//#define MBEDTLS_PLATFORM_TIME_TYPE_MACRO       time_t /**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
#define MBEDTLS_PLATFORM_FPRINTF_MACRO       f_error // fprintf /**< Default fprintf macro to use, can be undefined */
#define MBEDTLS_PLATFORM_PRINTF_MACRO        aw_kprintf // printf /**< Default printf macro to use, can be undefined */
/* Note: your snprintf must correclty zero-terminate the buffer! */
...
#define MBEDTLS_PSK_MAX_LEN               16 /* 128-bits keys are generally enough *//**< Max size of TLS pre-shared keys, in bytes (default 256 bits) */
