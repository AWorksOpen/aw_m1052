 ...
 */
IoT_Error_t zlg_iot_thread_mutex_init(IoT_Mutex_t *);
 ...
 * @return IoT_Error_t - error code indicating result of operation
 */
IoT_Error_t zlg_iot_thread_mutex_lock(IoT_Mutex_t *);
 ...
 * @return IoT_Error_t - error code indicating result of operation
 */
IoT_Error_t zlg_iot_thread_mutex_trylock(IoT_Mutex_t *);
 ...
 * @return IoT_Error_t - error code indicating result of operation
 */
IoT_Error_t zlg_iot_thread_mutex_unlock(IoT_Mutex_t *);
 ...
 * @return IoT_Error_t - error code indicating result of operation
 */
IoT_Error_t zlg_iot_thread_mutex_destroy(IoT_Mutex_t *);
