...
// Get from console
// =================================================
#define ZLG_IOT_AUTH_HOST              "auth.zlgcloud.com" 
#define ZLG_IOT_AUTH_PORT              8143
#define ZLG_IOT_TERMINAL_AUTH_PATH     "/v1/login"
#define ZLG_IOT_APP_USER_AUTH_PATH     "/v1/userLogin"

#define ZLG_IOT_ZWS_PORT               443
...
#define ZLG_IOT_MQTT_RX_BUF_LEN 2048 ///< Any message thatzws -key 07748630-d5fd-11e9-ade7-bd5a73f22a25 comes into the device should be less than this buffer size. If a received message is bigger than this buffer size the message will be dropped.
