...
/**
 * @file zlg_iot_mqtt_interface.h
 * @brief Interface definition for MQTT client.
 */

#ifndef ZLG_IOT_SDK_SRC_IOT_MQTT_INTERFACE_H
#define ZLG_IOT_SDK_SRC_IOT_MQTT_INTERFACE_H
...
/**
 * @brief MQTT Client Deinitialization Function
 *
 * Called to deinitialize the MQTT Client
 *
 * @param pClient Reference to the IoT Client
 *
 * @return IoT_Error_t Type defining successful/failed API call
