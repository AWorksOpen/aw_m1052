...
def mk_imx_bd_file(bd_file_path,srec_start_address,dcd_file_path = ''):
    ...
    #判断是否是XIP模式下执行的固件
    if ((srec_start_address >= 0x60002000) and 
        (srec_start_address < 0x60800000)):
        #XIP模式下start_address固定为0x60000000
    ...
    imx_bd_file.write('    ivtOffset = 0x1000;' + '\r\n');
...
if __name__ == '__main__':
    ...
    print_auto_encoding(u'本工具主要用于生成FlexSPI nor flash启动文件');
    #检查参数
